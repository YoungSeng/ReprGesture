...
def main():
    ...
    python calc_histogram.py -p your_prediction_dir -m velocity -w 0.05 # You can change the bin width of the histogram
    '''
    ...
    make_histogram(None, args.measure, None, args.out_dir, True, args.width)
