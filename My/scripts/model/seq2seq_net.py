...
class Seq2SeqNet(nn.Module):
    ...
    def forward(self, in_text, in_lengths, poses, vid_indices):
        ...
        in_text = in_text.transpose(0, 1)       # to (len, batch)
        poses = poses.transpose(0, 1)       # to (40, batch, 216)

        outputs = torch.zeros(self.n_frames, poses.size(1), self.decoder.output_size).to(poses.device)      # (40, batch, 216)
        ...
        return outputs.transpose(0, 1)      # (batch, 40, 216)
