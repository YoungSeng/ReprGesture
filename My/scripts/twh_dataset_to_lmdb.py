...
def process_bvh(gesture_filename, dump_pipeline=False):
    ...
    data_pipe = Pipeline([
        ...
        # ('mir', Mirror(axis='X', append=True)),     # 20220620
        ('np', Numpyfier())
    ])

    out_data = data_pipe.fit_transform(data_all)
    if dump_pipeline:
        pipeline_path = '<..your path/GENEA/genea_challenge_2022/baselines/Tri/resource/data_pipe_56_20220624.sav>'
        jl.dump(data_pipe, pipeline_path)
...
def make_lmdb_gesture_dataset(path):
    ...
    for bvh_file in bvh_files:
        ...
        # poses, poses_mirror = process_bvh(bvh_file, dump_pipeline)
        ...
        save_idx += 1
        print(str(save_idx) + ' / ' + str(len(bvh_files)), end='')
...
if __name__ == '__main__':
    '''
    python twh_dataset_to_lmdb.py <..your path/GENEA/genea_challenge_2022/dataset/TEST_2/>
    python twh_dataset_to_lmdb.py <..your path/GENEA/genea_challenge_2022/dataset/v1_18_1/>
    python twh_dataset_to_lmdb.py <..your path/GENEA/genea_challenge_2022/dataset/v1_56/>
    '''
